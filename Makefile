...
ifeq ($(CONFIG_CUSTOMER_BSH_GENERAL), y)
CONFIG_CUSTOMER_BSH = y
endif

ifeq ($(CONFIG_CUSTOMER_BSH), y)
EXTRA_CFLAGS += -DCONFIG_BSH_PROC
endif
...
obj-$(CONFIG_RTL8733BS) := $(MODULE_NAME).o

else

export CONFIG_RTL8733BS = m
